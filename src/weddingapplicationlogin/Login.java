...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Are you a planner?  LOGIN HERE ");

        jLabel7.setText("Contact Admin if want to register ");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 40, 430, 430));
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    if(option.equalsIgnoreCase("Admin") && s1.equalsIgnoreCase("admin")){
                        ...
                        JOptionPane.showMessageDialog(null,"Username and Password matched");
                        UserPage up = new UserPage(un);
                        up.setVisible(true);
                        setVisible(false);
                    }else{
                    JOptionPane.showMessageDialog(null,"Please check if User type is correct or You are not Authorized user.");
                    }
                }else{
